...
import FilterList from '@material-ui/icons/FilterFramesTwoTone';
...
class SearchBare extends React.Component {
 ...
 function MaxWidthDialog() {
    ...
    return (
      <React.Fragment >
        <Button variant="outlined" color="primary" onClick={handleClickOpen} style={{display:'Block',margin:"auto",color:"black"}}>
          Filter <FilterList style={{position:"relative",top:"5px"}}/>
        </Button>
        <Dialog
          fullWidth={fullWidth}
          maxWidth={"sm"}
